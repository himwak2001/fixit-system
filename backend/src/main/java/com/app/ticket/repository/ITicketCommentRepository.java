...
import com.app.ticket.dto.CommentDto;
...
public interface ITicketCommentRepository extends JpaRepository<TicketComment, UUID> {
    ...
    @Query("""
            SELECT new com.app.ticket.dto.CommentDto(
                    c.id, c.comment, u.fullName, c.createdAt, u.role
                )
            ...
            """)
    List<CommentDto> findDtoByTicketNumber(@Param("ticketNumber") String ticketNumber);
}
